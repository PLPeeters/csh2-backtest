...
export { allocateFidelityWithdrawals, assessFidelityPremiumTiming, assessFidelityPremiumTimings, buildCurrentRateEvolution, buildMarketReturnProjection, buildProjectedAccountReturnSeries, buildProjectedPrices, buildReturnProjection, estimateConstantRateHoldingPeriods, estimateConstantRateMatch, estimateOvernightRateMatch, estimateSavingsAccountRateMatch, estimateSavingsAccountRateMatches, findProjectedCrossover, orderFidelityAssessmentsByRecommendation, orderFidelityPremiumsForWithdrawal } from './backtest/projections.mjs';
export {

...
Mark an inflow as **Interest** when it was paid by the account being compared. Paid interest remains part of the actual account balance but is not treated as new external capital: it does not trigger a hypothetical CSH2 purchase and is not added to the euro overnight benchmark portfolio. Leave the box clear for interest or other money transferred in from outside the compared account.
